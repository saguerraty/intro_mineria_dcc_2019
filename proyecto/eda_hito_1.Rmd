...
#plotting Enero
ggplot(with(monthly_data,monthly_data[mes==1,]),aes(anno, O3)) + 
    geom_bar(stat="identity") + theme_minimal() +
    ggtitle("Tendencia de Ozono en Enero") +
    xlab("Años") + ylab("O3 (ppb)")

ggplot(with(monthly_data,monthly_data[mes ==1,]),aes(x=anno, y=MP10)) + 
    geom_bar(stat="identity") + theme_minimal() +
    ggtitle("Tendencia de MP10 en Enero") +
    xlab("Años") + ylab("Material Particulado (µg∕m3)")

ggplot(with(monthly_data,monthly_data[mes==1,]),aes(x=anno, y=CO)) + 
    geom_bar(stat="identity") + theme_minimal() +
    ggtitle("Tendencia de CO en Enero") +
    xlab("Años") + ylab("CO (ppm)")

ggplot(with(monthly_data,monthly_data[mes==1,]),aes(x=anno, y=SO2)) + 
    geom_bar(stat="identity") + theme_minimal() +
    ggtitle("Tendencia de SO2 en Enero") +
    xlab("Años") + ylab("SO2 (µg∕m3)")

ggplot(with(monthly_data,monthly_data[mes ==1,]),aes(x=anno, y=Tmedia)) + 
    geom_bar(stat="identity") + theme_minimal() +
    ggtitle("Tendencia de temperatura media en Enero") +
    xlab("Años") + ylab("T° (°C)")

ggplot(with(monthly_data,monthly_data[mes ==1,]),aes(x=anno, y=Tmax)) + 
    geom_bar(stat="identity") + theme_minimal() +
    ggtitle("Tendencia de temperatura máxima en Enero") +
    xlab("Años") + ylab("T° (°C)")

ggplot(with(monthly_data,monthly_data[mes ==1,]),aes(x=anno, y=Precipitaciones)) + 
    geom_bar(stat="identity") + theme_minimal() +
